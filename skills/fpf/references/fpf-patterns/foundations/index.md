...
| [A.16](A.16_formalityopenness_ladder_fol_building_closed_worlds_inside_an_open_world.md) | Formality–Openness Ladder (FOL): Building Closed Worlds Inside an Open World | Stub | *Keywords:* formality levels, rigor, proof, specification, sketch, F0-F9. *Queries:* "How to measure the formality of a document?", "What are the F0-F9 levels?" | **Builds on:** A.1. **Informs:** B.3. | 0.5 KB |
